...
const int IMPULSE_23			= 23;			// <unused> //Double G using it for inventory hud
const int IMPULSE_24			= 24;			// <unused> //spawn turret
const int IMPULSE_25			= 25;			// DOUBLE G Set to 1CTRL. Used for spawning inventory weps
